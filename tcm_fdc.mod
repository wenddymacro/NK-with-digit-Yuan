...
% This Dynare code simulates a 2-country NK model with CBDC
...
mudcstar sigdcstar kadcstar mustar ximstar sigmstar mss mstarss mudcz sigmdcz
...
dct=dc+dcstar;
mudcz*dcz^(-sigmdcz)=lambdaz-beta*lambdaz(1)/piz(1);
...
dct=dc+dcstar;
dcz=((lambdaz-beta*lambdaz/piz)/mudcz)^(-1/sigmdcz);
end;
